...
/******/ 	deferredModules.push(["./client/pages/prettier/index.tsx","reactVendors~home~prettierPage~react","prettier~prettierPage"]);
...
/***/ "./client/pages/prettier/index.tsx":
/*!*****************************************!*\
  !*** ./client/pages/prettier/index.tsx ***!
  \*****************************************/
/*! no static exports found */
...
"use strict";
eval("\r\nvar __importStar = (this && this.__importStar) || function (mod) {\r\n    if (mod && mod.__esModule) return mod;\r\n    var result = {};\r\n    if (mod != null) for (var k in mod) if (Object.hasOwnProperty.call(mod, k)) result[k] = mod[k];\r\n    result[\"default\"] = mod;\r\n    return result;\r\n};\r\nvar __importDefault = (this && this.__importDefault) || function (mod) {\r\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\r\n};\r\nObject.defineProperty(exports, \"__esModule\", { value: true });\r\nconst React = __importStar(__webpack_require__(/*! react */ \"./node_modules/react/index.js\"));\r\nconst layout_1 = __webpack_require__(/*! ../../layout */ \"./client/layout/index.tsx\");\r\nconst ga_provider_1 = __importDefault(__webpack_require__(/*! ../../ga-provider */ \"./client/ga-provider.tsx\"));\r\nconst standalone_1 = __importDefault(__webpack_require__(/*! prettier/standalone */ \"./node_modules/prettier/standalone.js\"));\r\nconst parser_graphql_1 = __importDefault(__webpack_require__(/*! prettier/parser-graphql */ \"./node_modules/prettier/parser-graphql.js\"));\r\nconst parser_babel_1 = __importDefault(__webpack_require__(/*! prettier/parser-babel */ \"./node_modules/prettier/parser-babel.js\"));\r\n// import typescript from \"prettier/parser-typescript\";\r\n// import flow from \"prettier/parser-flow\";\r\nconst parser_postcss_1 = __importDefault(__webpack_require__(/*! prettier/parser-postcss */ \"./node_modules/prettier/parser-postcss.js\"));\r\nconst parser_markdown_1 = __importDefault(__webpack_require__(/*! prettier/parser-markdown */ \"./node_modules/prettier/parser-markdown.js\"));\r\nconst parser_html_1 = __importDefault(__webpack_require__(/*! prettier/parser-html */ \"./node_modules/prettier/parser-html.js\"));\r\nconst parser_yaml_1 = __importDefault(__webpack_require__(/*! prettier/parser-yaml */ \"./node_modules/prettier/parser-yaml.js\"));\r\nclass Prettier extends React.Component {\r\n    constructor(props) {\r\n        super(props);\r\n        //   格式化插件对应配置\r\n        this.formatConfig = (item) => {\r\n            if (item.type === \"babel\" || item.type === \"babel-flow\" || item.type === \"json\" || item.type === \"json5\" || item.type === \"json-stringify\") {\r\n                return {\r\n                    parser: item.type,\r\n                    plugins: [parser_babel_1.default],\r\n                };\r\n            }\r\n            else if (item.type === \"babel-ts\" || item.type === \"typescript\") {\r\n                return {\r\n                // parser: item.type,\r\n                // plugins: [typescript],\r\n                };\r\n            }\r\n            else if (item.type === \"flow\") {\r\n                return {\r\n                // parser: item.type,\r\n                // plugins: [flow],\r\n                };\r\n            }\r\n            else if (item.type === \"css\" || item.type === \"scss\" || item.type === \"less\") {\r\n                return {\r\n                    parser: item.type,\r\n                    plugins: [parser_postcss_1.default],\r\n                };\r\n            }\r\n            else if (item.type === \"graphql\") {\r\n                return {\r\n                    parser: item.type,\r\n                    plugins: [parser_graphql_1.default],\r\n                };\r\n            }\r\n            else if (item.type === \"html\" || item.type === \"vue\" || item.type === \"angular\") {\r\n                return {\r\n                    parser: item.type,\r\n                    plugins: [parser_html_1.default],\r\n                };\r\n            }\r\n            else if (item.type === \"graphql\") {\r\n                return {\r\n                    parser: item.type,\r\n                    plugins: [parser_graphql_1.default],\r\n                };\r\n            }\r\n            else if (item.type === \"markdown\") {\r\n                return {\r\n                    parser: item.type,\r\n                    plugins: [parser_markdown_1.default],\r\n                };\r\n            }\r\n            else if (item.type === \"yaml\") {\r\n                return {\r\n                    parser: item.type,\r\n                    plugins: [parser_yaml_1.default],\r\n                };\r\n            }\r\n        };\r\n        //   开始格式化\r\n        this.startPretter = () => {\r\n            const { list } = this.context;\r\n            const { formatText, selectIndex } = this.state;\r\n            let selectItem = list[selectIndex];\r\n            let result;\r\n            if (selectItem.type === \"sp\") {\r\n                result = formatText.replace(/, /g, \"\\\",\\\"\")\r\n                    .replace(/=/g, \"\\\":\\\"\")\r\n                    .replace(/\\:\\{/g, \"\\\":{\\\"\")\r\n                    .replace(/入参csfParamMap/, \"{\\\"csfParamMap\")\r\n                    .replace(/入参object/, \",\\\"object\")\r\n                    .replace(/} ,/g, \"\\\"} ,\")\r\n                    .replace(/\\\"\\]/g, \"]\")\r\n                    .replace(/\\\"\\[/g, \"[\")\r\n                    .replace(/入参beans\\:\\[\\{/, \",\\\"},\\\"beans\\\":\\[{\\\"\")\r\n                    .replace(/入参beans\\:\\[/, \",\\\"},\\\"beans\\\":[\")\r\n                    .replace(\"返回编码：0 返回信息returnMessage：调用EOMS接口成功\", \"}\")\r\n                    .replace(/]\"/g, \"]\")\r\n                    .replace(/\\\"\\[/g, \"[\")\r\n                    .replace(/\\\"\\}\\]\\ }/g, \"\\\"\\\"\\}\\]\\}\")\r\n                    .replace(/\\\"\\}\\\"/g, \"\\\"\\\"\");\r\n            }\r\n            else {\r\n                result = standalone_1.default.format(formatText, this.formatConfig(selectItem));\r\n            }\r\n            console.log(result);\r\n            this.setState({\r\n                formatedText: result\r\n            }, () => {\r\n                this.formatedTextArea.current.style.height = this.formatedTextArea.current.scrollHeight + \"px\";\r\n            });\r\n        };\r\n        //改变格式化类型\r\n        this.changeFormatType = (e, index) => {\r\n            this.setState({\r\n                selectIndex: index\r\n            });\r\n        };\r\n        // 数据接收\r\n        this.inputValueChange = (key, value) => {\r\n            this.setState({\r\n                [key]: value,\r\n            });\r\n        };\r\n        this.formatTextArea = React.createRef();\r\n        this.formatedTextArea = React.createRef();\r\n        this.state = {\r\n            formatText: \"\",\r\n            formatedText: \"\",\r\n            selectIndex: 0,\r\n        };\r\n    }\r\n    static initData() {\r\n        let list = [\r\n            { title: \"babel\", type: \"babel\" },\r\n            { title: \"babel-flow\", type: \"babel-flow\" },\r\n            // { title: \"babel-ts\", type: \"babel-ts\" },\r\n            // { title: \"flow\", type: \"flow\" },\r\n            // { title: \"typescript\", type: \"typescript\" },\r\n            { title: \"css\", type: \"css\" },\r\n            { title: \"scss\", type: \"scss\" },\r\n            { title: \"less\", type: \"less\" },\r\n            { title: \"json\", type: \"json\" },\r\n            { title: \"json5\", type: \"json5\" },\r\n            { title: \"json-stringify\", type: \"json-stringify\" },\r\n            { title: \"graphql\", type: \"graphql\" },\r\n            { title: \"markdown\", type: \"markdown\" },\r\n            { title: \"mdx\", type: \"mdx\" },\r\n            { title: \"html\", type: \"html\" },\r\n            { title: \"vue\", type: \"vue\" },\r\n            { title: \"angular\", type: \"angular\" },\r\n            { title: \"lwc\", type: \"lwc\" },\r\n            { title: \"yaml\", type: \"yaml\" },\r\n            { title: \"特殊化json\", type: \"sp\" },\r\n        ];\r\n        return { list: list };\r\n    }\r\n    componentDidMount() { }\r\n    render() {\r\n        const { formatText, formatedText, selectIndex } = this.state;\r\n        const { list } = this.context;\r\n        return (React.createElement(layout_1.Layout, null,\r\n            React.createElement(\"div\", { className: \"container prettier\" },\r\n                React.createElement(\"div\", { className: \"formats\" },\r\n                    React.createElement(\"h5\", null, \"\\u8BF7\\u9009\\u62E9\\u4EE5\\u4E0B\\u4EFB\\u610F\\u4E00\\u79CD\"),\r\n                    list.map((item, index) => {\r\n                        return (React.createElement(\"span\", { onClick: (e) => this.changeFormatType(e, index), key: item.title, className: selectIndex !== index ? \"tag is-light\" : \"tag is-dark\" }, item.title));\r\n                    })),\r\n                React.createElement(\"div\", { className: \"content\" },\r\n                    React.createElement(\"div\", { className: \"columns\" },\r\n                        React.createElement(\"div\", { className: \"column is-two-fifths\" },\r\n                            React.createElement(\"label\", { className: \"active\" }, \"\\u5F85\\u683C\\u5F0F\\u5316\\u6587\\u672C\"),\r\n                            React.createElement(\"textarea\", { ref: this.formatTextArea, value: formatText, style: { minHeight: 200 }, className: \"textarea\", onChange: (e) => this.inputValueChange(\"formatText\", e.target.value) })),\r\n                        React.createElement(\"div\", { className: \"column center\" },\r\n                            React.createElement(\"button\", { className: \"button\", onClick: this.startPretter }, \"\\u683C\\u5F0F\\u5316\")),\r\n                        React.createElement(\"div\", { className: \"column is-two-fifths\" },\r\n                            React.createElement(\"label\", { className: \"active\" }, \"\\u683C\\u5F0F\\u5316\\u6587\\u672C\"),\r\n                            React.createElement(\"textarea\", { ref: this.formatedTextArea, value: formatedText, style: { minHeight: 200 }, className: \"textarea\", onChange: (e) => this.inputValueChange(\"formatedText\", e.target.value) })))))));\r\n    }\r\n}\r\nexports.default = Prettier;\r\nPrettier.contextType = ga_provider_1.default.context;\r\n\n\n//# sourceURL=webpack:///./client/pages/prettier/prettier.tsx?");
